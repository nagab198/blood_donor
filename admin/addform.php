...
if (isset($_POST['submit'])) {
    if (isset($_POST['blood_grp']) && $_POST['blood_grp'] != '') {
        $uname = $_POST['blood_grp'];
    } else {
        $error = "enter select blood group";
    }

    if ($error == null) {
        $sql = "INSERT INTO `blood_group`(`name`) VALUES ('$uname')";
    ...
    <form action="#" method="post" style="border-radius: 50px;">
        ...
        <div class="container">
            ...
            <div class="form-group">
                ...
                <select class="form-control" name="blood_grp" style="width: 60px;">
